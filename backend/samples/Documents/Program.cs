...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        ...
        options.Audience = builder.Configuration["Auth:Audience"] ?? "documents-service";
...
using (var scope = app.Services.CreateScope())
    scope.ServiceProvider.GetRequiredService<DocumentsDbContext>().Database.EnsureCreated();
